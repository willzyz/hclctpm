...
D = pd.read_csv('../data/hs_allcohort_maytoaug_2mil_data.csv') 
...
D.num_trips[D.num_trips == '\N'] = 0.0 
D.gross_bookings_usd[D.gross_bookings_usd == '\N'] = 0.0 
D.variable_contribution_usd[D.variable_contribution_usd == '\N'] = 0.0 
