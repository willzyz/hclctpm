...
use_schedule = True #False ## option to use a constraint annealing schedule 
temp = 10 #0.5 ## initial temperature for constraints 
inc_temp = 5 ## increment of temperature per 100 iterations 
...
data_filename =  '../data/eats_ma_training_data' 
prefix = 'eats_v5_07_08_featuremod3_tr_iter100_run4' 
