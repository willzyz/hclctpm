...
mb_batch_size = 15000 ## use large minibatches 
num_optimize_iterations = 20000 
num_benchmark_iterations = 800 
dropout_ratio = 0.0 
prepared_data_filename = 'data/hscls_seqdata_size1262582_allcohorts11weeks_save_latest.pkl' #hscls_seqdata_size754547_allcohorts11weeks_save_fixed_new.pkl' 
...
rldata = SeqDrmProcessData(prepared_data_filename, 
                           num_train = 700000, ##num_train=700000, 
                           seq_start=0) 
...
cpitobj, cpitopt, cpigbobj, cpigbopt, dumh_rscore = HetSequentialCausalModelDropout(num_units, 
...
#saver = tf.train.Saver() 
#saver.restore(sess, "modelsaves/hscls__16_16__numiter_14000_step_14000_dropout_0.5_data__size1262582_allcohorts11weeks__model.ckpt") 
#hscls__16_16__numiter_10000_step_9800_data__size754547_allcohorts11weeks__model.ckpt.meta") 
#hscls__16_16__numiter_2000_step_1800_dropout_0.5_data__size754547_allcohorts11weeks__model.ckpt") 

vcpitobj, vcpitopt, vcpigbobj, vcpigbopt, vhsclsrnkscores = HetSequentialCausalModelDropout(num_units, 
                                                                                     valDataFeatures, 
                                                                                     valDataSeqLens, 
