...
#benchmarkwithcv_tqr_drm_hte_r2e_v5_07_08_featuremod3_tr_iter100_run7_main_results.pkl', 'rb'))
ctpmscore = D['ctpmscore']
drmscore = D['drmscore']
...
### 
ot_cf = pd.read_csv('results/causal_forest_grf_test_set_results_O_ponfare_v3_causal_data_with_intensity_matching_d2dist_numtrees50_alpha_min_node_size_sample_fraction_global_iter_.csv') 
ct_cf = pd.read_csv('results/causal_forest_grf_test_set_results_C_ponfare_v3_causal_data_with_intensity_matching_d2dist_numtrees50_alpha_min_node_size_sample_fraction_global_iter_.csv') 
dt_cf = pd.read_csv('results/causal_forest_grf_test_set_results_D_ponfare_v3_causal_data_with_intensity_matching_d2dist_numtrees50_alpha_min_node_size_sample_fraction_global_iter_.csv') 
...
cfscore = np.divide(Ocfscores, Ccfscores) + d2dlamb*Dcfscores 
...
#saveD = {'ctpmscore':ctpmscore, 'drmscore':drmscore, 'quasiscore':pred_values_va_rlearner, 'quasiscore_O':pred_values_va_rlearner_O, 'rlearnerscore':rlearnerscores, 'ot':ot, 'wt':wt, 'ct':ct, 'tempvalue':tempvalue, 'p_quantilevalue':p_quantilevalue, 
#         'ctpmaucc':ctpmaucc, 'drmaucc':drmaucc, 'rlearnerauccs':rlearnerauccs, 'ranaucc':ranaucc, 'quasiaucc':quasiaucc} 
