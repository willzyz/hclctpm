...
d2dlamb = 3.0 
D = pkl.load(open('results/benchmarkwithcv_ctpm_drm_hte_uscensus_ctpm_icml_finalrun2_main_results_global_iter_7.pkl', 'rb')) 
ot = D['ot'] 
wt = D['wt'] 
ct = D['ct'] 

filelist = ['results/benchmarkwithcv_ctpm_drm_hte_uscensus_ctpm_icml_finalrun2_main_results_global_iter_'+str(i)+'.pkl' for i in range(13, 19)] 
best_ran_aucc, std_ran_aucc, best_ran_cc_series_cs, best_ran_cc_series_os, best_ran_aumc, std_ran_aumc, best_ran_cc_series_ps, best_ran_cc_series_ms, best_quasi_aucc, std_quasi_aucc, best_quasi_cc_series_cs, best_quasi_cc_series_os, best_quasi_aumc, std_quasi_aumc, best_quasi_cc_series_ps, best_quasi_cc_series_ms, best_ctpm_aucc, std_ctpm_aucc, best_ctpm_cc_series_cs, best_ctpm_cc_series_os, best_ctpm_aumc, std_ctpm_aumc, best_ctpm_cc_series_ps, best_ctpm_cc_series_ms, best_drm_aucc, std_drm_aucc, best_drm_cc_series_cs, best_drm_cc_series_os, best_drm_aumc, std_drm_aumc, best_drm_cc_series_ps, best_drm_cc_series_ms, ranos_std, ranms_std, quasios_std, quasims_std, ctpmos_std, ctpmms_std, drmos_std, drmms_std = exp.Aggregate_Curves_Best_std(filelist) 

min_cf_runs = 4 
max_cf_runs = 8 
cf_o_score_list = ['results/causal_forest_grf_test_set_results_O_uscensus_pub_causal_data_intensity_matching_d2dist_numtrees50_alpha0.2_min_node_size3_sample_fraction0.5_global_iter_'+str(i)+'.csv' for i in range(min_cf_runs, max_cf_runs)] 
cf_c_score_list = ['results/causal_forest_grf_test_set_results_C_uscensus_pub_causal_data_intensity_matching_d2dist_numtrees50_alpha0.2_min_node_size3_sample_fraction0.5_global_iter_'+str(i)+'.csv' for i in range(min_cf_runs, max_cf_runs)] 
cf_d_score_list = ['results/causal_forest_grf_test_set_results_D_uscensus_pub_causal_data_intensity_matching_d2dist_numtrees50_alpha0.2_min_node_size3_sample_fraction0.5_global_iter_'+str(i)+'.csv' for i in range(min_cf_runs, max_cf_runs)] 

best_cf_aucc, std_cf_aucc, best_cf_cc_series_cs, best_cf_cc_series_os, best_cf_aumc, std_cf_aumc, best_cf_cc_series_ps, best_cf_cc_series_ms, cfos_std, cfms_std = exp.Aggregate_CF_Curves_Best_std(cf_o_score_list, cf_c_score_list, cf_d_score_list, d2dlamb, wt, ot, ct) 
...
### --- print out aucc results for different models --- 
print('STD AUCC results: ') 
print('random: ' + str(std_ran_aucc)) 
print('rlearner: ' + str(std_quasi_aucc)) 
print('cf: ' + str(std_cf_aucc)) 
print('drm: ' + str(std_drm_aucc)) 
print('ctpm: ' + str(std_ctpm_aucc)) 
...
### --- print out aucc results for different models --- 
print('STD AUMC results: ') 
print('random: ' + str(std_ran_aumc)) 
print('rlearner: ' + str(std_quasi_aumc)) 
print('cf: ' + str(std_cf_aumc)) 
print('drm: ' + str(std_drm_aumc)) 
print('ctpm: ' + str(std_ctpm_aumc)) 
